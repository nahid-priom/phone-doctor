...
const Subcategory = () => {
  ...
  {/* Header Section */}
  <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-6 rounded-lg shadow-lg mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {models.map((model) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h3 className="text-lg font-semibold text-gray-800 text-center">{model.name}</h3>
                <div className="mt-2 flex justify-center">
                  {/* Example button or icon (e.g., a heart or cart icon) */}
                  <button className="bg-orange-500 text-white px-3 py-1 rounded-full hover:bg-orange-600 transition duration-200">
                    View Details
                  </button>
                </div>
              </div>
