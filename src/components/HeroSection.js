...
const HeroSection = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="py-10 bg-[#F2E8C6] lg:pt-20 pb-6 lg:pb-32">
        <div className="max-w-7xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8">
          ...
          >
            ...
            <h2 className="text-4xl text-center md:text-start text-gray-800 font-extrabold md:text-5xl">
              ENSURE YOUR VISA SUCCESS
            </h2>
            <p className="text-center md:text-start">
              Visa Processing Center is the premier visa agency in Bangladesh and we have helped hundreds of clients get their visas approved.
            </p>
          ...
          >
            <img
              src="https://www.travelvisapro.com/wp-content/uploads/2017/09/india-visa-tourist-1.jpg"
